...
#include <stdlib.h>
#include <math.h>
#define DATASIZE 262144//375000 			//Total size of image
#define H 512//500 							//Height of image
#define W 512//750 							//width og image
...
int main( ) 
{
    input_file = fopen("lena_gray.raw","rb");			//Open input file
...
// 5*5 Filtering of the image in horizontal and vertical diection.
	...
	IMG33_X = fopen("IMG_X33.raw","wb");
    fwrite(OUTPUT33_X, 1, DATASIZE, IMG33_X);
    fclose(IMG33_X);
    IMG33_Y = fopen("IMG_Y33.raw","wb");
    fwrite(OUTPUT33_Y, 1, DATASIZE, IMG33_Y);
    fclose(IMG33_Y);
	IMG55_X = fopen("IMG_X55.raw","wb");
    fwrite(OUTPUT55_X, 1, DATASIZE, IMG55_X);
    fclose(IMG55_X);
    IMG55_Y = fopen("IMG_Y55.raw","wb");
